...
from retfound.models_vit_update import vit_large_patch16_with_lrp as vit_large_patch16
from retfound.util.datasets import build_transform

# Set device based on parsed GPU IDs
parser = argparse.ArgumentParser()
parser.add_argument('--gpu_ids', type=str, default='6, 7', help='Comma-separated GPU IDs to use, e.g., "0,1,2"')
...
experiment = {
    ...
    "num_classes": 5,
    "output_folder": "/home/user/yatpan/RETFound_MAE/output/brset/10/dr_messi/"
}
